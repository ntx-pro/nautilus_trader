...
impl_catalog_path_prefix!(nautilus_model::events::order::initialized::OrderInitialized, "order_initializations");
...
impl_catalog_path_prefix!(nautilus_model::events::order::updated::OrderUpdated, "order_updates");
impl_catalog_path_prefix!(nautilus_model::events::order::pending_cancel::OrderPendingCancel, "order_pending_cancels");
impl_catalog_path_prefix!(nautilus_model::events::order::pending_update::OrderPendingUpdate, "order_pending_updates");
impl_catalog_path_prefix!(nautilus_model::events::order::submitted::OrderSubmitted, "order_submissions");
